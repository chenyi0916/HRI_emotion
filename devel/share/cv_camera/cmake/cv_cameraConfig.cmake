...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/ur3/HRI_emotion/src/drivers/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/ur3/HRI_emotion/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/ur3/HRI_emotion/install)
...
if(NOT "/home/ur3/HRI_emotion/src/drivers/cv_camera/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/ur3/HRI_emotion/src/drivers/cv_camera/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ur3/HRI_emotion/src/drivers/cv_camera/${idir}'.  ${_report}")
    endif()
